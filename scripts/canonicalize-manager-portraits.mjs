...
const portraits = [
  ...
  ["aime-jacquet", "aimejacquet.png"],
  ["carlos-alberto-parreira", "carlosalbertop.png"],
  ["cesar-luis-menotti", "CesarLuisMenotti.png"],
  ["alejandro-sabella", "AlejandroSabella.png"],
  ["bruno-metsu", "BrunoMetsu.png"],
  ["luiz-felipe-scolari", "LuizFelipeScolari.png"],
  ["franz-beckenbauer", "franz.png"],
  ["arrigo-sacchi", "ArrigoSacchi.png"],
  ["kazimierz-gorski", "KazimierzGorski.png"],
  ["rinus-michels", "rinus.png"],
  ["guy-thys", "GuyThys.png"],
  ["oscar-tabarez", "OscarTabarez.png"],
  ["michel-hidalgo", "MichelHidalgo.png"],
  ["rudi-voller", "RudiVoller.png"],
  ["herve-renard", "HerveRenard.png"],
  ["azeglio-vicini", "AzeglioVicini.png"],
  ["bobby-robson", "BobbyRobson.png"],
  ["tommy-svensson", "TommySvensson.png"],
  ["carlos-bilardo", "carlosbilardo.png"],
];
